...
class RealFrankaFold(tfds.core.GeneratorBasedBuilder):
    """
    ...
    def __init__(self, **kwargs):
        ...
        """
        dataset_name = "real_franka_folding"
        self.dataset_name = dataset_name
        self.raw_data_path = "/home/hongyi/DATA/folding_dataset"
        super().__init__()
...
def process_episode_data(file_path):
    ...
    try:
        ...
        for idx in range(len(episode_data)):
            ...
            action = episode_data[idx]['leader_robot']['joint_pos'].cpu().numpy()
            gripper_action = episode_data[idx]['leader_robot']['gripper_state']
            ...
            steps.append({
                'is_first': idx == 0,
                'is_last': idx == len(episode_data) - 1,
                'observation': {
...
if __name__ == "__main__":
    # folder_path = "/home/hongyi/DATA/folding_dataset"
